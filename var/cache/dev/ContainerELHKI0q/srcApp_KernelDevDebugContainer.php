...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('3c3SQ1IE6g', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9G6-e-y7uU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UfRzvimMNw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I6jY3mUlBX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CnSFGADge4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JQ-d58zGMh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r1Obr3xl2B', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldereb13a = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerfe3a0 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties6f7e6 = [
        
    ];

    public function getConnection()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getConnection', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getMetadataFactory', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getExpressionBuilder', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'beginTransaction', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getCache', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getCache();
    }

    public function transactional($func)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'transactional', array('func' => $func), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'wrapInTransaction', array('func' => $func), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'commit', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->commit();
    }

    public function rollback()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'rollback', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getClassMetadata', array('className' => $className), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'createQuery', array('dql' => $dql), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'createNamedQuery', array('name' => $name), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'createQueryBuilder', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'flush', array('entity' => $entity), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'clear', array('entityName' => $entityName), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->clear($entityName);
    }

    public function close()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'close', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->close();
    }

    public function persist($entity)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'persist', array('entity' => $entity), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'remove', array('entity' => $entity), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'refresh', array('entity' => $entity), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'detach', array('entity' => $entity), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'merge', array('entity' => $entity), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getRepository', array('entityName' => $entityName), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'contains', array('entity' => $entity), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getEventManager', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getConfiguration', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'isOpen', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getUnitOfWork', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getProxyFactory', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'initializeObject', array('obj' => $obj), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'getFilters', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'isFiltersStateClean', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'hasFilters', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return $this->valueHoldereb13a->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerfe3a0 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldereb13a) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldereb13a = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldereb13a->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, '__get', ['name' => $name], $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        if (isset(self::$publicProperties6f7e6[$name])) {
            return $this->valueHoldereb13a->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldereb13a;
    ...
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;
    ...
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, '__isset', array('name' => $name), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;
    ...
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, '__unset', array('name' => $name), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;
    ...
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, '__clone', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        $this->valueHoldereb13a = clone $this->valueHoldereb13a;
    }

    public function __sleep()
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, '__sleep', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        return array('valueHoldereb13a');
    }
    ...
    {
        $this->initializerfe3a0 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerfe3a0;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'initializeProxy', array(), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldereb13a;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldereb13a;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerfe3a0 && ($this->initializerfe3a0->__invoke($valueHoldereb13a, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerfe3a0) || 1) && $this->valueHoldereb13a = $valueHoldereb13a;

        if ($this->valueHoldereb13a === $returnValue = $this->valueHoldereb13a->paginate($target, $page, $limit, $options)) {
            return $this;
        }
